				...
				["components"] = {
					{
						...
						["style"] = 5,
						["disabled"] = false,
						["label"] = "Tempbanned Player Profile",
...
return command.new({
	...
	executor = function(args)
		send_temp_ban(args.player, find_player.find(args.command_arguments[1]), ban_reason_formatted(args.combined_command_arguments))
